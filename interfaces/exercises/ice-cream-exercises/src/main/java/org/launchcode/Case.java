...
public class Case {
    ...
    public Case(){
        ...
        Topping topping1 = new Topping("Gummies", 0.25, new ArrayList<>(Arrays.asList( "red 40","yellow","blue")));
        Topping topping2 = new Topping("Hot fudge", 0.5, new ArrayList<>(Arrays.asList( "dairy")));
        Topping topping3 = new Topping("Resess pecess", 0.75, new ArrayList<>(Arrays.asList( "peanuts", "dairy")));
